...
import com.example.razashop.adapters.AllOrdersAdapter
import com.example.razashop.databinding.FragmentOrdersBinding
import com.example.razashop.utils.Resource
import com.example.razashop.viewmodels.AllOrdersViewModel
...
class AllOrdersFragment : Fragment(R.layout.fragment_orders) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ordersAdapter.onItemClick = {
            val action =
                AllOrdersFragmentDirections.actionAllOrdersFragmentToOrderDetailsFragment(it)
